...
public class CreatingStreams {
	public static void main(String[] args) {
		...
		Stream<String> streamer1 = Stream.of(strArr);
		Stream<Integer> streamer2 = intList.stream();
		Stream<Random> streamer3 = randStack.stream();
		Stream<Double> streamer4 = dQueue.stream();
	}
}
